...
if __name__ == "__main__":
    ...
    dm = FoundationalDataModule(
        ...
        path_to_ds=data_dir + "dataset/",
        load=True,
        adapter="BEHRT",
    )

    # View sample (in FastEHR format as conversion is done during collation)
    ...
    with open(data_dir + "adapted/BEHRT/pretrain/token2idx.pkl", "wb") as f:
